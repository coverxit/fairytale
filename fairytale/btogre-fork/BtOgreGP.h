...
public:
	...
	AnimatedMeshToShapeConverter(fairytale::engine::Engine* eng, Ogre::Entity *entity, const Ogre::Matrix4 &transform = Ogre::Matrix4::IDENTITY);
	AnimatedMeshToShapeConverter(fairytale::engine::Engine* eng);

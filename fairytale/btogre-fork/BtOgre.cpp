 ...
 */
	...
	AnimatedMeshToShapeConverter::AnimatedMeshToShapeConverter(fairytale::engine::Engine* eng, Entity *entity,const Matrix4 &transform) :
	VertexIndexToShape(transform),
	mEntity (0),
	mNode (0),
	mTransformedVerticesTemp(0),
	mTransformedVerticesTempSize(0), mEngine(eng)
	{
		addEntity(entity, transform);
	}
	//------------------------------------------------------------------------------------------------
	AnimatedMeshToShapeConverter::AnimatedMeshToShapeConverter(fairytale::engine::Engine* eng) :
	VertexIndexToShape(),
	mEntity (0),
	mNode (0),
	mTransformedVerticesTemp(0),

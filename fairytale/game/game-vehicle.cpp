...
namespace fairytale
{
	...
	*/
	...
	/// September 2006: Vehicle is work in progress, this file is mostly just a placeholder
	/// This Vehicle file is very early in development, please check it later
...
#define  USE_TRIMESH_GROUND 1
	...
	bool Vehicle::keyReleased(const OIS::KeyEvent& evt)
	{
		switch (evt.key) 
		{
		case OIS::KC_UP :
	...
	bool Vehicle::keyPressed(const OIS::KeyEvent& evt)
	{
		switch (evt.key) 
		{
		case OIS::KC_LEFT : 
